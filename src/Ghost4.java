...
public class Ghost4 extends Thread {
    ...
    public Ghost4(JTable jTable, ImageIcon ghost, int currentRow, int currentColumn, int[][] maze) {
        this.jTable = jTable;
        this.ghost = ghost;
        ...
        while (isRunning) {
            try {
                ...
                if (newRow >= 0 && newRow < maze.length && newColumn >= 0 && newColumn < maze[0].length && maze[newRow][newColumn] != 1) {
                    ...
                    jTable.setValueAt(new ImageIcon("/Users/jakuborzelowski/Documents/Java/Projekt_2/src/Images/ghost4.jpg"), newRow, newColumn);
                    jTable.repaint();
